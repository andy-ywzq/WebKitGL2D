...
if (APPLE)
    file(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/Source/cmake/Features${PORT}Mac.config" featureData NEWLINE_CONSUME)
else()
...
if (APPLE)
    ...
    mark_as_advanced(GLEW_LIBRARY READLINE_LIBRARY CARBON_LIBRARY APPKIT_LIBRARY IOKIT_LIBRARY FOUNDATION_LIBRARY CG_LIBRARY)
endif()
